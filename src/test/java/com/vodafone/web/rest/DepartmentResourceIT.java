...
import com.vodafone.WebappApp;
import com.vodafone.config.TestSecurityConfiguration;
import com.vodafone.domain.Department;
import com.vodafone.repository.DepartmentRepository;
import com.vodafone.repository.search.DepartmentSearchRepository;
 ...
 */
@SpringBootTest(classes = {WebappApp.class, TestSecurityConfiguration.class})
public class DepartmentResourceIT {
    ...
    /**
     * This repository is mocked in the com.vodafone.repository.search test package.
     *
     * @see com.vodafone.repository.search.DepartmentSearchRepositoryMockConfiguration
     */
    @Autowired
